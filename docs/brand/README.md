# Calibrate Pro Brand Assets

The README hero image in this folder was rendered as part of the Project Telos flagship presentation pass.
...
- Product role: measured display calibration and verification.
- Tool-specific motif: panel gamut arcs, calibration target, and a measured-color readout.
