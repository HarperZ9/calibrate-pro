...
- Product role: display calibration, LUT generation, monitor control, and verification reports.
- Tool-specific motif: color-volume/gamut view, measured target, and verification label.
